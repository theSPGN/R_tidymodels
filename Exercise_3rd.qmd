...
A ja mam 3 przypadki. 

```{r}
set.seed(345)
vcv_folds <- vfold_cv(data=train_data, v=10)
vcv_folds <- vfold_cv(data=train_data, v=10, repeats = 5)
...
A o tym nie pomyślałem, dodajmy to.
...
Czy nie można dac tego w jednej tabeli i łądnie ja wyświetlić i opisać. Po co generować kilka tabel, Kto zapamieta twoje zonaczenia. 
